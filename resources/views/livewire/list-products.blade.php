    ...
    <table class="table-auto w-full text-center divide-y-2 divide-violet-400 hover:divide-pink-400">
        ...
        <tbody>
            ...
            <tr class="hover:bg-violet-900 hover:text-white odd:bg-gray-200">
                ...
                <td>{{ $product->total_outlet_stocks }}</td>
                ...
                <td>
                    <div x-data="{ modal_open: false }">
                        ...
                        <div x-show="modal_open"
                            ...
                            <a href="{{ route('add-stocks', ['id' => $product->id]) }}">
                                <button>
                                    <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 448 512"
                            ...
                            <a href="{{ route('add-outlet_stocks', ['id' => $product->id]) }}">
                                <button>
                                    <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 448 512"
                                        class="fill-red-600">
                                        <!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                    ...
                    <a href="{{ route('edit-model', ['id' => $product->id]) }}">
                        <button>
                            <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512"
                                class="fill-blue-600">
                                <!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                    ...
                    <div x-data="{ modal_open_delete: false }">
                        ...
                        <div x-show="modal_open_delete"
                            ...
                            <div class="flex flex-col justify-center items-center">
                                ...
                                {{-- <button class="w-1/2 bg-red-600 text-white rounded-full">No</button> --}}
